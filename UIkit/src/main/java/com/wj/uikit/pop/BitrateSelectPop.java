 ...
 * 作者姓名 修改时间 版本号 描述
 */
public  class BitrateSelectPop  extends AttachPopupView {
    ...
    protected int getImplLayoutId() {
        return R.layout.wj_birate_select_pop;
    }

    public BitrateSelectPop(Context context) {
        super(context);
    }
