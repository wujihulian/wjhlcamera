 ...
 * 作者姓名 修改时间 版本号 描述
 */
public class WJRelationAssist implements AssistPlay {
    ...
    public WJRelationAssist(Context context){
        this(context, null);
    }

    public WJRelationAssist(Context context, SuperContainer superContainer){
        this.mContext = context;
        mPlayer = new AVPlayer(ExoMediaPlayer.PLAN_ID);
            ...
            new OnReceiverEventListener() {
                ...
                public void onReceiverEvent(int eventCode, Bundle bundle) {
                    ...
                    if(mOnEventAssistHandler !=null)
                        mOnEventAssistHandler.onAssistHandle(WJRelationAssist.this, eventCode, bundle);
